...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mnsavings.conf'
CONFIGFOLDER='/root/.mnsavings'
COIN_DAEMON='mnsavingsd'
COIN_CLI='mnsavings-cli'
COIN_TX='mnsavings-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/mnsccoin/src/releases/download/1010/mnsc-linux1010.zip'
...
COIN_NAME='mnsavings'
COIN_NAME_OLD='mnsavingsd'
PROJECT_NAME='mnsavings (mnsc)'
COIN_EXPLORER='http://208.85.21.92/'
COIN_PORT=5727
RPC_PORT=5726
...
#   sleep 3
  ...
  echo -e "\n${RED}$PROJECT_NAME ${GREEN}Service Status\n${NC}"
...
cat << EOF > /root/mnsavings-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/mnsavings-general-info

cat << EOF > /root/mnsavings-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/mnsavings-fee-info

cat << EOF > /root/mnsavings-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/mnsavings-networkinfo

cat << EOF > /root/mnsavings-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/mnsavings-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/mnsavingsinfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias mnsavingsinfo='/root/mnsavings-general-info'" >> /root/.bashrc
echo -e "alias feestats='/root/mnsavings-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/mnsavings-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/mnsavings-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}mnsavings-cli getinfo${NC}, ${RED}mnsavings-cli getnetworkinfo${NC}, ${RED}mnsavings-cli getconnectioncount${NC}commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
