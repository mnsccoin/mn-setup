...
function important_information() {
 ...
 echo -e "You can also use ${RED}mnsavings-cli getinfo${NC}, ${RED}mnsavings-cli getblockcount${NC}, ${RED}mnsavings-cli getmasternodewinners${NC} and ${RED}mnsavings-cli getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
